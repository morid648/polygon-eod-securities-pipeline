...
CREATE OR REPLACE STORAGE INTEGRATION INT_S3_AIRFLOWSNOWDE
  ...
  STORAGE_PROVIDER = S3
  ENABLED = TRUE
  STORAGE_AWS_ROLE_ARN = 'arn:aws:iam::<YOUR_AWS_ACCOUNT_ID>:role/snowflake_s3_integration_role'
  STORAGE_ALLOWED_LOCATIONS = ('s3://<YOUR_S3_BUCKET>/market/bronze/');
...
CREATE OR REPLACE STAGE SEC_PRICING.RAW.EXT_BRONZE
  URL = 's3://<YOUR_S3_BUCKET>/market/bronze/'
